(function($) {
    jQuery.fn.html5_upload = function(options) {
        ...
        var options = jQuery.extend({
            ...
            sendBoundary: false,
            files: [],
            fieldName: 'file',//'user_file[]',//ignore if sendBoundary is false
            method: 'post',
...
//                    	alert("FormData");
                        ...
                        f.append("filename", get_file_name(file));
                        xhr.send(f);
                    }
                    else 
                    	if (file.getAsBinary) {//Thanks to jm.schelcher
